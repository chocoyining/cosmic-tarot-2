const ZH = {
  landing: {
    subtagline_mobile: "透过塔罗与星象，让我引领你\n找到生命中的清明，照亮前方的道路，\n发现真实的自己。",
    subtagline_desktop: "透过塔罗与星象，让我引领你找到生命中的清明，\n照亮前方的道路，发现真实的自己。",
    ...
    para2: "在我几乎对生活失去信念之前，我在朋友的推荐下，完成了人生中的第一次塔罗占卜。在我的牌阵中，翻出了一张「太阳」牌。牌翻过来的那一刻，我感到一道光穿透厚厚的乌云，轻轻照在我最灰暗的心里，告诉我"这不是世界的终点"。\n我得到了一种宁静的力量，似乎眼前原本漆黑的路径被微微地点亮。我重新找到了方向，一小步、一小步地跟随塔罗的指引，走出了黑暗。",
    para3: "一开始我本来是为了自己而学习的塔罗占卜，但当我开始为身边的朋友解读，反馈让我深受感动...",
    para4: "很多朋友通过塔罗找到了内心真正的渴望，认清一些早该结束的关系，理解何为业力，接受并释然，轻柔地疗愈那些无声作痛的伤疤。",
    para5: "今天，我以中文和英文为大众提供个人塔罗 · 星座命盘解读，使用的是一副以我家小博美犬为灵感，并由我亲手设计的牌卡，期待能为每次的解读注入更温柔纯粹的力量。",
    para6: "最后，塔罗牌是否能预知未来？不，你的未来永远取决于你的行动。我所给予的，是将可能性清晰地展示在你的面前，一个安全的、让你更了解自己、并鼓起勇气迈出下一步的空间。",
